...
const placeholderTexts = {
    ru: [
        'Посоветуй аппартаменты в Новгороде на 15-20 июля',
        'Покажи свободные аппартаменты на 2-3 августа в Пскове для двоих',
        'Отель в Москве на 5-17 августа',
        'Аппартаменты в Ташкенте на сутки на завтра'
    ],
    en: [
        'Recommend hotels in Novgorod for March 15–20',
        'Show available hotels in Moscow for two people from December 25–28',
        'A hotel in Moscow from April 5–17 for up to $40 per day',
        'Hotels in Tashkent for one night'
    ],
        el: [
...
const userLang = 'ru'; // navigator.language.slice(0, 2); // Например, 'ru-RU' → 'ru'
